...
@interface HISearchBar()<UITextFieldDelegate>
{
    ...
    HISearchBarIconAlign _iconAlignTemp;
}

@end

@implementation HISearchBar
...
-(void)setIconAlign:(HISearchBarIconAlign)iconAlign{
    if(!_iconAlignTemp){
...
-(void)ajustIconWith:(HISearchBarIconAlign)iconAlign{
    if (_iconAlign == HISearchBarIconAlignCenter) {
        ...
        if (!_iconCenterView) {
            _iconCenterView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"HISearchBar_ICON"]];
...
{
    if(_iconAlignTemp == HISearchBarIconAlignCenter){
...
{
    if(_iconAlignTemp == HISearchBarIconAlignCenter){
        self.iconAlign = HISearchBarIconAlignCenter;
    }
